...
void count_four_h() {
  ...
  if (beg_min < 10 && holder_min < 10){
    breaks3 = beg.toString() + ':' + '0' + beg_min.toString() + '-' + holder_beg.toString() + ':' + '0' + holder_min.toString();
  }else if(holder_min < 10){
    breaks3 = beg.toString() + ':' + beg_min.toString() + '-' + holder_beg.toString() + ':' + '0' + holder_min.toString();
  }else if(beg_min < 10){
    breaks3 = beg.toString() + ':' + '0' + beg_min.toString() + '-' + holder_beg.toString() + ':' + holder_min.toString();
  }else{
    breaks3 = beg.toString() + ':' + beg_min.toString() + '-' + holder_beg.toString() + ':' + holder_min.toString();
  }
  ...
  if (beg_min < 10 && holder_min < 10){
    four_double = beg.toString() + ':' + '0' + beg_min.toString() + '-' + holder_beg.toString() + ':' + '0' + holder_min.toString();
  }else if(holder_min < 10){
    four_double = beg.toString() + ':' + beg_min.toString() + '-' + holder_beg.toString() + ':' + '0' + holder_min.toString();
  }else if(beg_min < 10){
    four_double = beg.toString() + ':' + '0' + beg_min.toString() + '-' + holder_beg.toString() + ':' + holder_min.toString();
  }else{
    four_double = beg.toString() + ':' + beg_min.toString() + '-' + holder_beg.toString() + ':' + holder_min.toString();
  }
}