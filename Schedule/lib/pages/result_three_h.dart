...
class ResultThreeH extends StatefulWidget {
  @override
  _ResultThreeH createState() => _ResultThreeH();
}

class _ResultThreeH extends State<ResultThreeH> {
  @override
  ...
  List<ItemModel> itemData = <ItemModel>[
    ...
    ItemModel(
      ...
      discription:'''Купи в столовой плотный обед!
      Всего за 120 рублей!
            ''',
